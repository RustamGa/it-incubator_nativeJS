...
const Lesson1: React.FunctionComponent = () => {
    return (
        /// <React.Fragment> обертка для того чтоб не ломалтись стили, т.е. пустой тег <></>,
        // позволяет корректно возвращать некоторые сущности в основное дерево и реакт без проблем рисует dom  и
        // чтоб не ломалась верстка
    <React.Fragment>
